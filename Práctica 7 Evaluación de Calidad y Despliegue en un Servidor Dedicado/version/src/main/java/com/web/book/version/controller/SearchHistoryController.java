...
public class SearchHistoryController {
    ...
    public String deleteSearchRecord(@PathVariable Long id) {
        try {
            searchHistoryService.deleteSearchRecord(id);
            return "redirect:/history?deleted=true";
        } catch (Exception e) {
            logger.error("Error deleting search record: {}", e.getMessage());
            return "redirect:/history?error=true";
        }
    }
    ...
    public String clearAllHistory() {
        try {
            ...
            logger.error("Error clearing all history: {}", e.getMessage());
            return "redirect:/history?error=true";
        }
    }
}
